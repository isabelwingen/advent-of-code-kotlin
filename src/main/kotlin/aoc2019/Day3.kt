...
data class Operation(val dir: Direction, val steps: Int)
...
fun executeDay3Part1(name: String = "2019/day3.txt"): Int {
...
fun executeDay3Part2(name: String = "2019/day3.txt"): Int {
    val (first, second) = parseInput(name)
    val firstPath = executePath(first)
    val secondPath = executePath(second)
