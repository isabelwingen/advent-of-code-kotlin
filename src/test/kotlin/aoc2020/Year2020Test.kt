...
internal class Year2020Test {
    ...
    @Test
    fun testDay21Part2() {
        assertEquals("jzzjz,bxkrd,pllzxb,gjddl,xfqnss,dzkb,vspv,dxvsp", Day21().executePart2())
    }
